...
RP_REPORT_STATUS = 1
RP_REPORT_ACK = 2
RP_STATUS_INITIAL_REGISTER = 0
RP_STATUS_QUERY_STATUS = 1
RP_STATUS_ANSWER_STATUS = 2
RP_STATUS_QUERY_VALUE = 3
RP_STATUS_ANSWER_VALUE = 4
RP_STATUS_QUERY_STATE = 5
RP_STATUS_ANSWER_STATE = 6
RP_STATUS_QUERY_ALL_STATES = 7
