...
public:
    ...
    bool sendServerAutoEnum(uint16_t id);   
    bool sendCarAutoEnum(uint16_t id);   
    bool sendNodeId(uint16_t id);   
    bool sendCarId(uint16_t id);   
    bool sendRCId(uint16_t id);  
	bool sendRCCarRegister(uint16_t carid, uint8_t serverid);   
    bool sendRCCarRegisterAck(uint16_t carid, uint8_t serverid); 
    bool sendAcquire(uint16_t carid, uint8_t serverid);   
    bool sendAcquireAck(uint16_t carid, uint8_t serverid);   
	bool sendAcquireNAck(uint16_t carid, uint8_t serverid);   
    bool sendCarRelease(uint16_t carid, uint8_t serverid);   
    bool sendCarReleaseAck(uint16_t carid, uint8_t serverid);   
    bool sendCarKeepAlive(uint16_t carid, uint8_t serverid);   
    bool sendRCKeepAlive(uint16_t carid, uint8_t serverid);   
    bool sendSaveParam(uint16_t carid, uint8_t serverid, uint8_t idx, uint8_t value );   
    bool sendRCTurn(uint16_t carid, uint8_t serverid,uint8_t angle, uint8_t direction);
    bool sendRCMove(uint16_t carid, uint8_t serverid,uint8_t speed, uint8_t direction);
    bool sendCarLightOnOff(uint16_t carid, uint8_t serverid);   
